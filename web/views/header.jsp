...
<head>
    ...
    <title>Sistema Academico - ITCAltamirano</title>
    ...
    <script>
        function delete_area(id_to_delete)
        {
            var confirmation = confirm(String.fromCharCode(191)+'Est\u00E1 seguro de que desea eliminar area con clave '+ id_to_delete);

            if(confirmation)
            {
                window.location = "borrar_area.jsp?id_area="+id_to_delete;
            }
        }
    </script>
