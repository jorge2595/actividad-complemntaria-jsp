...
@WebServlet(name = "ServletCrearArea", urlPatterns = {"/crearArea"})
public class ServletCrearArea extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(cc.agregarArea(nuevaArea)) {
            response.sendRedirect("areas.jsp");
        } else {
            response.sendRedirect("a_area.jsp");
        }
    }
